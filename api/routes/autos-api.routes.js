...
route.put("/autos/:id", [validateAuto, validateToken], controllersPeugot.remplazarAuto); // remplazar
route.patch("/autos/:id", [validateAuto, validateToken], controllersPeugot.actualizarAuto); // actualizar
route.delete("/autos/:id", [validateToken], controllersPeugot.eliminadoLogico); // eliminar
